...
<div class="container mx-auto mt-2 p-4">
    <div class="bg-gray-800 p-6 rounded-lg shadow-lg max-w-md mx-auto">
        <h3 class="mb-4 text-2xl font-bold text-white">Добавить продукт</h3>
        @if ($errors->any())
        ...
        <form action="{{ route('products.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="article" id="article" class="shadow appearance-none border rounded w-full py-2 px-3 bg-white text-black leading-tight focus:outline-none focus:shadow-outline" value="{{ old('article') }}" required>
            </div>
            <div class="mb-4">
                <label for="name" class="block text-gray-300 text-sm font-bold mb-2">Название</label>
                <input type="text" name="name" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 bg-white text-black leading-tight focus:outline-none focus:shadow-outline" value="{{ old('name') }}" required>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="data[color]" id="color" class="shadow appearance-none border rounded w-full py-2 px-3 bg-white text-black leading-tight focus:outline-none focus:shadow-outline" value="{{ old('data.color') }}">
            </div>
            <div class="mb-4">
                <label for="size" class="block text-gray-300 text-sm font-bold mb-2">Размер</label>
                <input type="text" name="data[size]" id="size" class="shadow appearance-none border rounded w-full py-2 px-3 bg-white text-black leading-tight focus:outline-none focus:shadow-outline" value="{{ old('data.size') }}">
            </div>
